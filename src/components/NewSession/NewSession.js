    ...
    <div className="session">
      <div className="container text-center">
        ...
        <div className="d-flex justify-content-evenly align-items-center">
          ...
          <div>
            <h2 className="fs-1 text-light"><CountUp start={focus ? 0 : null} end={45} duration={2} redraw={true}>
            {({ countUpRef }) => (
              <div>
                <span ref={countUpRef} />
                <VisibilitySensor
          ...
          <div>
            <h2 className="fs-1 text-light"><CountUp start={focus ? 0 : null} end={48} duration={2} redraw={true}>
            {({ countUpRef }) => (
              <div>
                <span ref={countUpRef} />
                <VisibilitySensor
          ...
          <div>
            <h2 className="fs-1 text-light"><CountUp start={focus ? 0 : null} end={59} duration={2} redraw={true}>
            {({ countUpRef }) => (
              <div>
                <span ref={countUpRef} />
                <VisibilitySensor
